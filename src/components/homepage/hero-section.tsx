...
export const HeroSection = () => {
  return (
    <div className="flex w-full overflow-hidden bg-background sm:pt-[60px] sm:pb-[76px] sm:flex-col sm:gap-0  md:flex-row md:px-4 md:h-[calc(100vh-84px)] lg:flex-row lg:gap-[39px] lg:px-10 md:py-20 xl:px-20 xl:py-[34px] md:justify-between 2xl:py-0 2xl:px-[120px] 2xl:flex-wrap 2xl:content-center  2xl:gap-[111px] xl:gap-[102px] md:items-start md:gap-[32px] xl:items-center">
      ...
      <div className="flex items-center md:items-start lg:w-[468px] md:justify-end xl:w-[568px] 2xl:flex-wrap 2xl:justify-center 2xl:w-[637px] ">
        <div className="relative max-h-[568px] w-full max-w-[568px] sm:mt-[52px] sm:h-[414px] sm:w-[414px] md:mt-8 md:h-[360px] md:w-[360px] lg:mt-0 2xl:mt-0 lg:h-[460px] lg:w-[460px] xl:w-[568px] xl:h-[568px] xl:items-center">
          <Image
          ...
          <Image
            ...
            className="absolute sm:top-[367px] sm:right-[16px] md:right-[20px] md:top-[340px] lg:right-[-3px] lg:top-[-2px] xl:top-[43px] xl:right-[60px]"
            alt="Typography"
            width={320}
            height={48}
          />
          <Image
            ...
            className="absolute sm:right-[255px] sm:top-[281px] md:right-64 md:top-[250px] lg:right-[37px] lg:top-[166px] xl:right-[107px] xl:top-[216px]"
            alt="ATS"
            width={77}
            height={28}
          />
          <Image
            ...
            className="invisible absolute lg:visible lg:bottom-[104px] lg:right-[-16px] xl:bottom-[160px] xl:right-[10px]"
            alt="AI"
            width={181}
            height={88}
          />
          ...
          <Image
            ...
            className="absolute sm:bottom-[376px] sm:left-[84px] md:bottom-[355.2px] md:left-[90px] lg:bottom-[204px] lg:left-[14px] xl:bottom-[175px] xl:left-[22px]"
            alt="Colors"
            width={250}
            height={33}
          />
